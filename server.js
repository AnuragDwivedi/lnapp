...
console.log('process.env.IP: %s', process.env.PORT);
console.log('process.env.OPENSHIFT_NODEJS_PORT: %s', process.env.PORT);
console.log('process.env.OPENSHIFT_NODEJS_IP: %s', process.env.PORT);
